...
my $keep_log=1;
my $verbose=1;
my $bengversion='vLN1.02	.. uh, alpha';
...
my %spells=(
#Status
blunt=>{cost=>'40',damage=>'0',description=>'A weak enemy is a good enemy'},
...
poison=>{cost=>'30',damage=>'0',description=>'I dont feel so good'},
...
defence_down=>{cost=>'30',damage=>'0',description=>'Hit them now! NOW!'},
...
return_damage=>{cost=>'250',damage=>'-1',description=>'What goes around comes around'},


#special
spraypaint=>{cost=>'2',damage=>'0',description=>'All the colours of the rainbow'},
lick=>{cost=>'1',damage=>'-1',description=>'MMM!  Tasty!'},
bloodsuck=>{cost=>'150',damage=>'0',description=>'The best spell.. OF VAMPIRES'},
ultimate_end=>{cost=>'2000',damage=>'0',description=>'Like in FF7'},
...
#normal
zapper=>{cost=>'20',damage=>'100',description=>'Duck Hunt Et All'},
...
pyrokinesis=>{cost=>'50',damage=>'125',description=>'Hot hot HOT!'},
telekinesis=>{cost=>'150',damage=>'500',description=>'Pick em up and throw em down'},
pulse_wave=>{cost=>'500',damage=>'5000',description=>'Waves of psionic energy and a huge explosion'},
...
mega_flare=>{cost=>'999',damage=>'9999',description=>'Behold the king of dragons'},
...
oracle=>{user=>1,hp=>30,mp=>40,xp=>120,damage=>10,spells=>{regen=>1,mind_regen=>3,poison=>5,mpshield=>7,blunt=>10,damage_double=>15,defense_down=>20,protect=>25,return_damage=>30,slow_burn=>40}},
psionist=>{user=>1,hp=>20,mp=>40,xp=>100,damage=>12,spells=>{scan=>1, vanish=>2, vertigo=>5, mpshield=>3, damage_double=>15, blunt=>20, mind_drain=>8, pyrokinesis=>10, mind_regen=>30, pulse_wave=>50, telekinesis=>25, mind_blast=>35, slow_burn=>40, meditate=>24, sneak=>13}},
angel=>{user=>1,hp=>35,mp=>18,xp=>150,damage=>9,spells=>{regen=>6,preach=>1,fly=>3,cure=>2,wound=>5,raise=>8,damn=>15,heal=>20,omniscience=>25,revive=>35,life=>37,smite=>40,mind_regen=>30}}, 
demon=>{user=>1,hp=>40,mp=>20,xp=>160,damage=>10,spells=>{poison=>6,wound=>4,raise=>9,devilish=>14,defence_down=>40,instill=>15,fissure=>25,omniscience=>30}},  
fighter=>{user=>1,hp=>50,mp=>0,xp=>100,damage=>10,spells=>{},win=>0},
monk=>{user=>1,hp=>30,mp=>0,xp=>100,damage=>14,spells=>{},win=>0},
ninja=>{user=>1,hp=>30,mp=>12,xp=>120,damage=>12,spells=>{vanish=>2,return_damage=>35,shuriken=>3,smoke_bomb=>5,top_cut=>7,shadow_strike=>10,ethereal_blade=>23,chirijiraden=>50},win=>0},
thief=>{user=>1,hp=>30,mp=>12,xp=>120,damage=>6,spells=>{hide=>1,sneak=>3,throw=>2,backstab=>6,mug=>9,sneak_attack=>22,steal_armor=>30,mind_drain=>40,plunder=>50},win=>0},
theif=>{user=>1,hp=>30,mp=>12,xp=>120,damage=>6,spells=>{lame=>1,duh=>1},win=>0},
robot=>{user=>1,hp=>40,mp=>10,xp=>100,damage=>8,spells=>{spark=>2,scan=>5,candy_beam=>10,taser=>15,lightning=>20,protect=>30,gravity_bomb=>26,assimilate=>50},win=>0},
...
mage=>{user=>1,hp=>30,mp=>20,xp=>150,damage=>5,spells=>{flare=>1,spark=>2,ice=>3,fireball=>5,cure=>7,lightning=>10,unholy=>13,heal=>17,meteo=>20,poison=>30,magic_missile=>50},win=>0},
summoner=>{user=>1,hp=>20,mp=>40,xp=>160,damage=>4,spells=>{},win=>0},
healer=>{user=>1,hp=>40,mp=>20,xp=>120,damage=>8,spells=>{cure=>1,heal=>3,raise=>7,wound=>10,regen=>30,revive=>15,life=>20,heal_all=>25,negate=>50},win=>0},
...
dancer=>{user=>1,hp=>30,mp=>20,xp=>150,damage=>5,spells=>{happy_dance=>2,waltz=>3,tansu_dance=>1,disco_fever=>5,sword_dance=>7,tangle_tango=>10,danse_macabre=>30,dance_of_special_words=>50,dance_of_the_sacred_spirits=>40},win=>0},
hunter=>{user=>1,hp=>50,mp=>0,xp=>100,damage=>10,spells=>{}},
mimic=>{user=>1,hp=>40,mp=>0,xp=>150,damage=>6,spells=>{}},

#peanut_of_ultimate_peril=>{user=>0,hp=>9999,mp=>999,xp=>9999,damage=>120,spells=>{peanut_butter_is_very_very_sticky=>1}},

the_mall_after_being_exposed_to_radation_and_chemicals=>{user=>0,hp=>1500,mp=>999,xp=>1500,damage=>20,spells=>{paper_or_plastic=>1,sam_the_record_man=>1,attention_shoppers=>1,on_sale=>1}},

witch_doctor=>{user=>0,hp=>600,mp=>700,xp=>1500,damage=>20,spells=>{poison=>1,regen=>1,damage_double=>1,blunt=>1,slow_burn=>1,mpshield=>1}},
marathon_man=>{user=>0,hp=>100000,mp=>100000,xp=>10000,damage=>100,spells=>{regenerate=>1,regen=>1,fireball=>1}},
doctor=>{user=>0,hp=>1000,mp=>1000,xp=>1000,damage=>-200,spells=>{heal_you=>1,regenerate=>1,regen=>1,revive=>1,heal=>1,cure=>1}},

gumshoe=>{user=>0,hp=>1000,mp=>500,xp=>300,damage=>30,spells=>{zapper=>1}},

unicorn_jelly=>{user=>1,hp=>10,mp=>5,xp=>50,damage=>20,spells=>{spark=>5,cure=>8}},
town_fool=>{user=>1,hp=>30,mp=>14,xp=>30,damage=>4,spells=>{duh=>1}},
...
can_of_summon=>{user=>0,hp=>1,mp=>0,xp=>50,damage=>0,spells=>{}},
...
slime=>{user=>1,hp=>10,mp=>2,xp=>30,damage=>3,spells=>{spark=>7,cure=>10,poison=>30,slow_burn=>50},win=>0}, #webrunner
...
ghoul=>{user=>0,hp=>200,mp=>200,xp=>700,hitsas=>6,damage=>20,spells=>{ghoulish=>1,mpshield=>1}},
...
giant_spider=>{user=>0,hp=>500,mp=>100,xp=>2000,hitsas=>16,damage=>50,spells=>{web=>1,poison=>1}},
radioactive_spider=>{user=>0,hp=>500,mp=>100,xp=>3000,hitsas=>16,damage=>50,spells=>{web=>1,rbite=>1,poison=>1}},
black_drake=>{user=>0,hp=>400,mp=>150,xp=>1200,hitsas=>14,damage=>20,spells=>{acid_spray=>1,poison=>1}},
troll=>{user=>0,hp=>800,mp=>400,xp=>2400,hitsas=>18,damage=>40,spells=>{regenerate=>1,regen=>1,mind_regen=>1}},
...
metal_slime=>{user=>0,hp=>60,mp=>300,xp=>600,hitsas=>4,damage=>10,spells=>{acid_shower=>1,heal=>1,protect=>1}},
slime_king=>{user=>0,hp=>60,mp=>20,xp=>300,hitsas=>4,damage=>15,spells=>{cure=>1,spark=>1,regen=>1}},
...
green_dragon=>{user=>0,hp=>500,mp=>120,xp=>1200,damage=>20,spells=>{poison_breath=>1, poison=>1}},
red_dragon=>{user=>0,hp=>1000,mp=>200,xp=>2400,damage=>30,spells=>{fire_breath=>1,slow_burn=>1}},
shadow_dragon=>{user=>0,hp=>2000,mp=>500,xp=>4800,damage=>50,spells=>{shadow_breath=>1,unholy=>1,ghoulish=>1,blunt=>1}},
...
sub hunt{my ($hunter,$monster,$area)=@_;
	...
	if($characters{$hunter}->{class} ne 'hunter'){
	...
	if($characters{$hunter}->{delay}<time()){
		say("\2$hunter\2 tries to track down a \2$monster\2 in \2$area\2...");
		wander($hunter, $area, $monster, $characters{$hunter}->{level});
		$characters{$hunter}->{delay}=time()+5;
	}else{
		penalty($hunter);
	}
}
...
my $choice=rand_el('red','blue','yellow','octarine','plaid','purple','white','orange');
...
lick=>sub {my ($caster, $target)=@_;
	...
	say("Mmm!  $choice!");
	cause_damage($caster,$caster,-5);
	if ($target ne $caster) {
	say("\2$caster\2 offers \2$target\2 a lick too!"); cause_damage($caster,$target,-5); }
	
	return 0;
},
bloodsuck=>sub {my ($caster, $target)=@_;
	cause_damage($caster,$target,200);
	cause_damage($target,$caster,-200);
	return 1;
	},

ultimate_end=>sub {my ($caster, $target)=@_;
	say("Lengthy animation not included");
	cause_damage($caster,$target,7000);
	cause_damage($caster,$target,7000);
	cause_damage($caster,$target,7000);
	cause_damage($caster,$target,7000);
	cause_damage($caster,$target,7000);
	...
	cause_damage($caster,$target,7000);
	cause_damage($caster,$target,7000);
	cause_damage($caster,$target,9999);
return 1;
},
...
heal_you=>sub {my ($caster, $target) = @_;   
	cause_damage($caster,$target,-500);
	return 0;
},


mind_blast=>sub {my ($caster, $target) = @_;
	mp_damage($caster,$target,500);
	return 0;
},
meditate=> sub {my ($caster, $target) = @_;
	 cause_damage($caster,$caster,-2000);
	 return 0;
},
...
paper_or_plastic=>sub {($caster, $target)=@_;
	...
	if ($choice eq 'paper') {
		say ("Paper it is!");
		cause_damage($caster,$target,150);
	}
	elsif ($choice eq 'plastic') {
		say ("Plastic?  Sure!");
		cause_damage($caster,$caster,-150);
	}
	elsif ($choice eq 'ill_wear_it_home') {
		say ("I'll wear it home, thanks.");
		cause_damage($caster,$target,300);
		cause_damage($caster,$caster,100);
	}
...
sub cause_status{ my ($target)=@_;
    if ( exists( $characters{$target} ) ) {
		...
		say("\2$target\'s $characters{$target}->{seffect} has worn off!");
		$characters{$target}->{seffect} = "none"; }
             if ( $characters{$target}->{seffect} eq 'poison' ) {
                cause_damage('Poison',$target,40);
		 ...
		 correct_points($target);
                   ...
                   cause_damage('burning',$target,200);
                   if ( $characters{$target}->{hp} <= 0 ) { 
                    defeats_status($characters{$target}->{seffname},$target);
...
unlabelled_can_of_mystery=>sub{ my ($name,$killer)=@_;
	...
	my $choice=rand_el('exp','potion','insanity','nothing','dogfood',
	 'cure','slime','dragon','can','peaches','coca-cola');
	delete $characters{$name};
	if($choice eq 'exp'){
...
can_of_summon=>sub{ my ($name,$killer)=@_;
	say("You open the can to find...");
	my $choice=rand_el('ifrit','bahamut','ramuh','diablos','slime',
 'knights_of_the_round','slime','shiva','can','chocobo','slime','lollypop','non_fighter_monk','wolf','wolf_rider','vampire','bizarre_cannery');
	delete $characters{$name};
...
# loading stuff
sub load{
	open LOADFILE, "<lnbeng.state" or return;
	print "Loading...";
	eval(join('',<LOADFILE>));
	close LOADFILE;
	foreach $name (keys %characters){
...
sub cause_damage{ my ($attacker,$name,$amount)=@_;
	...
	elsif($characters{$attacker}->{seffect} eq 'damage/2') { $amount = $amount / 2; }
	if($characters{$name}->{seffect} eq 'return_damage') {
		cause_damage($name,$attacker,$amount);
		if ($characters{$attacker}->{hp} <= 0) { defeats($name,$attacker); return; }
	}
	elsif($characters{$name}->{seffect} eq 'protect') {
		$amount = $amount * .75;
	}
	elsif($characters{$name}->{seffect} eq 'weak_bodied') {
		$amount = $amount * 1.5;
	}
	if($amount == 0){
...
sub status{ my ($name)=@_;
	...
	say("\2$name\2 is a level \2$characters{$name}->{level}\2 ".
	 ...
	 "\2 needed for next level.) Status effect: $characters{$name}->{seffect}");
}
...
sub intro{
	...
	say("Try '\2BEng help\2'.");
        say("Latest updates: Now Available!");
        say("Latest bug fixes: N/A");
        say("Current hint: Foo");
}
	...
	if($text =~ /^\s*beng\s+(.+)$/i){
		...
		if(exists($characters{$from}) &&
		 ($characters{$from}->{staticid} ne $static)){
			...
			sayto($from,"If this is actually your account, use '\2\/msg LN_BattleEngine login PASSWORD\2' to log in (and create a password, if you hadn't before).");
		...
		if(/^join\s+(\S+)/i){
			...
			if(/^(\S+)/ && exists($spells{lc($1)})){
				...
				sayto($from,"These are the classes: \2summoner\2, \2fighter\2, \2mage\2, \2healer\2, \2ninja\2, \2bard\2, \2robot\2, \2thief\2, \2harlot\2, \2monk\2, \2slime\2, \2psionist\2, and \2dancer\2.");
			}elsif(/^wander/i){
			...
			if(/^hit\s+(\S+)/i){
                ...
                cause_status($from);  ## Cause status effects to character. - webrunner
